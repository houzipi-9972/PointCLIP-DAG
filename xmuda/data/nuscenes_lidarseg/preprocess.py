...
def preprocess(nusc, split_names, root_dir, out_dir,
    ...
    for i, sample in enumerate(nusc.sample):
        ...
        pts_cam_coord = pts_cam_coord.T[:, pts_valid_flag]  # 相机坐标系下的点云
...
if __name__ == '__main__':
    # root_dir = '/media/wy/dataset/nuScenes/nuscenes'
    # out_dir = '/media/wy/dataset/nuScenes/nuscenes_lidarseg_intensity_preprocess'
    root_dir = '/data/user2/nuscenes'
    out_dir = '/data/wuyao/dataset/nuscenes/nuscenes_lidarseg_preprocess_merge'
