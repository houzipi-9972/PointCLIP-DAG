...
class VirtualKITTIBase(Dataset):
    ...
    categories = {
        ...
        # Open-vocabulary setup with vehicle superclass used as base class.
        # truck/car are kept in classifier vocabulary as novel classes but are
        # mapped to vehicle during source supervised training.
        "GLOBAL_OV_VEHICLE": {
            'vegetation_terrain': ['Terrain', 'Tree', 'Vegetation'],
            'building': ['Building'],
            'road': ['Road'],
    ...
    def __init__(self,
        ...
        if merge_classes_style is None:
            merge_classes_style = "VirtualKITTI" if merge_classes else None
