...
_C.DATASET_SOURCE.SemanticKITTISCN.train_on_base_only = False
_C.DATASET_SOURCE.SemanticKITTISCN.base_class_indices = tuple()
# 3D
...
# UniDSeg
_C.DATASET_TARGET.SemanticKITTISCN.use_color = False
...
_C.DATASET_SOURCE.VirtualKITTISCN.merge_classes_style = 'VirtualKITTI'
_C.DATASET_SOURCE.VirtualKITTISCN.train_on_base_only = False
_C.DATASET_SOURCE.VirtualKITTISCN.base_class_indices = tuple()
# 3D
...
_C.MODEL_2D.USE_HIERARCHY_IN_FEATURES = False
_C.MODEL_2D.USE_HIERARCHY_REGULARIZATION = False
_C.MODEL_2D.TEMPERATURE = 0.07
_C.MODEL_2D.PROMPT_TEMPLATE = "a photo of a {}"
_C.MODEL_2D.DUAL_HEAD = False
_C.MODEL_2D.OPEN_VOCAB = False
_C.MODEL_2D.CLASS_NAMES = tuple()
_C.MODEL_2D.BASE_CLASS_IDX = tuple()
_C.MODEL_2D.NOVEL_CLASS_IDX = tuple()
_C.MODEL_2D.TEXT_PROMPTS = ("a photo of a {}", "a point cloud scene with {}")
_C.MODEL_2D.LOGIT_SCALE = 30.0
_C.MODEL_2D.INFER_DROP_CLASS_IDX = tuple()
# ---------------------------------------------------------------------------- #
...
_C.MODEL_3D.USE_HIERARCHY_IN_FEATURES = False
_C.MODEL_3D.USE_HIERARCHY_REGULARIZATION = False
_C.MODEL_3D.TEMPERATURE = 0.07
_C.MODEL_3D.PROMPT_TEMPLATE = "a photo of a {}"
_C.MODEL_3D.DUAL_HEAD = False
_C.MODEL_3D.OPEN_VOCAB = False
_C.MODEL_3D.CLASS_NAMES = tuple()
_C.MODEL_3D.BASE_CLASS_IDX = tuple()
_C.MODEL_3D.NOVEL_CLASS_IDX = tuple()
_C.MODEL_3D.TEXT_PROMPTS = ("a photo of a {}", "a point cloud scene with {}")
_C.MODEL_3D.LOGIT_SCALE = 30.0
_C.MODEL_3D.INFER_DROP_CLASS_IDX = tuple()
# ----------------------------------------------------------------------------- #
# SCN options
# ----------------------------------------------------------------------------- #
_C.MODEL_3D.SCN = CN()
