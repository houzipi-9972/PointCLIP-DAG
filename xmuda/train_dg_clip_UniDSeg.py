...
def train(cfg, output_dir='', run_name=''):
    ...
    logger.info('Experiment: DG | source={} -> target={}'.format(cfg.DATASET_SOURCE.TYPE, cfg.DATASET_TARGET.TYPE))
    ...
    logger.info('Loss weights | xm_src={:.4f}'.format(cfg.TRAIN.XMUDA.lambda_xm_src))
